				...
				<form action="update.do" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="inputArea">
						<label>1차 분류</label> <select class="category1" >
							<option value="${goods.cateName }">전체</option>
						</select> <label>2차 분류</label> <select class="category2" name="cateCode">
							<option value="${goods.cateCode }">전체</option>
						</select>
					</div>
					<div class="inputArea">
					...
					<div class="inputArea">
					   ...
					   <img src="/Spring-ShoppingEx${goods.gdsImg }" />
					...
					<div class="inputArea">
						...
						<script>
							$("#back_Btn").click(function() {
								//history.back();
								location.href = "/Spring-ShoppingEx/goodsinfo.do?n=" + ${goods.gdsNum};
							});
						</script>
					</div>
				</form>
