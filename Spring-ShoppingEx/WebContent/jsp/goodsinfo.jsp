...
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/jquery-compat/3.0.0-alpha1/jquery.min.js"></script>
<!-- 합쳐지고 최소화된 최신 CSS -->
	...
	<div id="root">
		...
		<section id="container">
			...
			<div id="container_box">
				<h2>상품조회</h2>
				<form action="goodsinfo.do" method="post" autocomplete="off">
					...
					<div class="inputArea">
						...
						<p>원본 이미지</p>
						<img src="/Spring-ShoppingEx${goods.gdsImg}" class="oriImg" />

						<p>썸네일</p>
						<img src="/Spring-ShoppingEx${goods.gdsThumbImg}" class="thumbImg" />
					...
					<div class="inputArea">
						...
						<script>
							...
							$("#modify_Btn").click(function() {
								formObj.attr("action", "/Spring-ShoppingEx/modify.do?cateName=");
							...
							$("#delete_Btn").click(function() {
								...
								if(con){
								formObj.attr("action", "/Spring-ShoppingEx/delete.do");
								formObj.submit();
